			...
			<div class="card mb-3" id="vehicleCard">
			  ...
			  <div class="card-body">
				...
				<div class="row">
		    		...
		    		<div class="col-lg-12">
   						<div class="input-group">
			      			<input type="text" id="searchFleetNumber" class="form-control form-control-lg" placeholder="Fleet Number">
			    		</div>
		    		</div>
		  		</div>
   				<p></p>
		   		<div class="row">
			    	...
			    	<div class="col-lg-6">
   						<a href="#" data-toggle="modal" data-target="#addVehicleModal" id="vehicleAddBtn" class="btn btn-secondary form-control form-control-lg ">Add New</a>
			  		</div>
		  		</div>
			  	<p></p>
			    <div id="vehicleList">
			  ...
			  <div class="card-body">
			    <div id="orderItemContainer" class="card-text">
					  ...
					  <div id="firstOrderItem" class="form-row align-items-center mb-3 mb-0-print orderItemSerialize">
					    ...
					    <div class="col-md-1 col-print-2">
					        <input type="text" class="form-control priceChange orderItemQuantity" placeholder="Quantity" value="1">
					    </div>
					    <div class="col-md-2 col-print-2">
					      <div class="input-group mb-2 mb-sm-0">
					        <div class="input-group-addon d-print-none">$</div>
					        <input type="text" class="form-control priceChange orderItemRetail" placeholder="Retail" value="0.00">
					      </div>
					    </div>
					    <div class="col-md-1 col-print-2">
			...
			<div class="card" id="totalsCard">
			  ...
			  <div class="card-body">
				  ...
				  <div class="form-group row" id="grandTotalRow">
					...
					<div class="form-group row">
						<div class="col-md-4">
							<a href="#" id="workOrderSaveBtn" class="btn btn-primary form-control d-print-none">Save</a>
						</div>
						<div class="col-md-4">
							<a href="#" id="saveAndPrintBtn" class="btn btn-secondary form-control d-print-none">Save & Print</a>
						</div>
						<div class="col-md-4">
					...
					<div class="modal-body">
						...
						<form id="customerInfoForm">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label class="custom-control custom-checkbox">
									  <input type="checkbox" name="isPrimary" class="custom-control-input" id="customerPrimaryContact" value="1" checked="checked">
									  <span class="custom-control-indicator"></span>
						...
						<form id="vehicleAddForm">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-4">
									...
									<input type="text" class="form-control vehicleSerialize" name="fleetnum" id="vehicleAddFleetNum">
									<p style="display: none;color: red;" id="show_wo_err"></p>
